...
class StoreUsuarioRequest extends FormRequest
{
    ...
    {
        return [
            'doc_usuario'        => 'required|string|max:45|unique:usuarios,doc_usuario',
            'tipo_documento'     => 'required|in:CE,TI,CC',
            'contrasena_usuario' => 'required|string|max:100',
            'email_usuario'      => 'required|email|max:100|unique:usuarios,email_usuario',
    ...
    public function messages()
    {
        return [
            ...
            'telefono_usuario.required'   => 'El numero de teléfono es obligatorio.',
